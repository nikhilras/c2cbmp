								...
								<div class="col-sm-2">
									...
									<p>
										<input id="l" type="text" min="0"
											data-ng-model="quckItems.length1"
								...
								<div class="col-sm-2">
									...
									<p>
										<input id="w" type="text" min="0"
											data-ng-model="quckItems.width" class="form-control input-sm"
											placeholder="Width" onblur="test()" /> <label id="c2"
											style="color: Red; font-size: 13px;">Character not
											allowed</label>
									</p>
								</div>
								...
								<div class="col-sm-2">
									...
									<p>
										<input id="h" type="text" min="0"
											data-ng-model="quckItems.height"
								...
								<div class="col-sm-2">
									...
									<p>
										<input id="wg" type="text" min="0"
											data-ng-model="quckItems.weight"
							...
							<div class="row">
								...
								<div class="col-sm-2">
									...
									<a class="btn btn_create inscan_btn_color btn-sm  btn-block "
										data-ng-click="saveOrderDetails()" href="#Div2" role="button"
										data-slide="next" id="mybtn" style="font-weight: bold;">
										Submit</a>
								</div>
							</div>
						</div>
