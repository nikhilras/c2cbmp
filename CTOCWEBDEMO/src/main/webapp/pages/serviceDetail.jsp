...
<div class="item " data-ng-controller="serviceDetailController" data-ng-init="init()">
	<div class="row">
		<div class="col-sm-12">
					...
					<div class="row">
						<div class="col-sm-3">
							<h4 style="color: rgb(143, 200, 67); font-weight: bold">Collecting
								From</h4>
							<span style="color: gray; font-weight: bold" >{{fromZoneName}}</span>
						</div>
						<div class="col-sm-1">
						...
						<div class="col-sm-2  text-default">
							<h4 style="color: rgb(143, 200, 67); font-weight: bold">Shipping
								To</h4>
							<span style="color: gray; font-weight: bold">{{toZoneName}}</span>
						</div>
						<div class="col-sm-1">
							<i class="fa fa-arrow-circle-right fa-2x"
								style="color: rgb(143, 200, 67); margin-top: 10px"></i>
											...
											<div class="row text-center text-capitalize">
												<div class="col-sm-12"
													...
													<a class="btn btn-sm btn-primary" href="#Div2"
														role="button" data-slide="next" style="font-weight: bold;">Book
														Now</a>
												</div>
											</div>
										</div>
										...
										<div class="panel-body">
											<div class="row text-center text-capitalize">
												<div class="col-sm-12"
													...
													<a class="btn btn-sm btn-primary" href="#Div2"
														role="button" data-slide="next" style="font-weight: bold;">
														Book Now</a>
												</div>
											</div>
										</div>
